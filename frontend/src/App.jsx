...
export default function App() {
  ...
  // --- COMPONENT UI (JSX) ---
  return (
    // 1. OUTMOST WRAPPER (No side padding here so the header can go edge-to-edge)
    <div className="min-h-screen bg-neutral-950 text-neutral-200 font-sans selection:bg-teal-700 selection:text-neutral-900 print:bg-white print:text-black print:p-0">
      
      {/* 2. THE FULL-WIDTH WHITE HEADER */}
      <div className="w-full bg-white border-b-4 border-neutral-900 print:hidden">
        <div className="max-w-3xl mx-auto px-6 pt-10 pb-8 text-center flex flex-col items-center">
          ...
          <p className="text-lg text-neutral-600 font-medium max-w-2xl mx-auto mt-4">
            Upload your piano audio and instantly generate clean, playable sheet music.
          </p>
        </div>
      </div>

      {/* 3. THE DARK CONTENT WRAPPER (Padding applied here for the main app body) */}
      <div className="p-6 md:p-12">
        
        {/* Sliders Container (Hidden when printing) */}
